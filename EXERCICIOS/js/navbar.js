// <a> do Home
// esta é a atualizada
const aExercicio = criaAncora('/exercicios/exercicio1.html', 'Exrc1');
// esta constante é a inicial
...
function criaAncora(url, texto) {
    const aHome = document.createElement('a');
aHome.setAttribute('href', url);
aHome.innerHTML = texto;

return criaAncora;
} /* esta função FUNCTION precisará de uma url e texto para realizar sua função 
